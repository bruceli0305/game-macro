...
UI_ShowMain() {
    ...
    UI_RegisterPage("default_skill", "默认技能", Page_DefaultSkill_Build, Page_DefaultSkill_Layout,
    ...
    UI_RegisterPage("settings_lang", "界面语言", Page_Settings_Lang_Build, Page_Settings_Lang_Layout,
        Page_Settings_Lang_OnEnter)
    UI_RegisterPage("settings_about", "关于", Page_Settings_About_Build, Page_Settings_About_Layout,
